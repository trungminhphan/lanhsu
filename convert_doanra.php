...
if(isset($_POST['submit'])){
	...
	if($doanra->convert()){
		//$doanra_regis->id = $id;
		//$doanra_regis->set_status(1);
		transfers_to('doanra_regis.php?update=convert_ok');
	} else {
		$msg = 'Không thể xử lý';
	}
} //end submit
if($id_regis){
	$doanra_regis->id = $id_regis; $dr = $doanra_regis->get_one();
...
<h1><a href="doanra_regis.php" class="nav-button transform"><span></span></a>&nbsp;Xử lý đăng ký trực tuyến - Đoàn ra</h1>
...
<div class="grid">
					...
					echo '<div class="row cells12" style="padding:0px 0px 10px 0px;margin:0px;">';
						...
						echo '<div class="cell colspan10 input-control text">';
							...
							echo '<div class="button-group">';
								echo '<a href="../lanhsuthutuc/get.xoataptin.php?filename='.$cvxp['alias_name'].'" onclick="return false;" class="delete_file button"><span class="mif-cross fg-red"></span></a>';
	...
	<div class="row cells12">
		<div class="cell colspan2 padding-top-10 align-right"><b>9. Kinh phí</b></div>
		<div class="cell colspan4 input-control select" data-role="select">
