...
$abtc=new ABTC(); $abtc_regis = new ABTC_Regis();
...
<h1><a href="abtc_regis.php" class="nav-button transform"><span></span></a>&nbsp;Xử lý đăng ký trực tuyến - Cấp thẻ ABTC</h1>
...
<input type="hidden" name="id" id="id" value="<?php echo isset($id_regis) ? $id_regis : ''; ?>" />
<input type="hidden" name="masohoso" id="masohoso" value="<?php echo isset($masohoso) ? $masohoso : ''; ?>" />
<div class="grid">
	...
	<div class="row cells12">
		<div class="cell colspan12">
			...
			<tbody>
			<?php if($id_regis && isset($thongtinthanhvien) && $thongtinthanhvien) : ?>
				...
				foreach ($giaytolienquan as $gt) {
					echo '<div class="row cells12" style="padding:0px 0px 10px 0px;margin:0px;">';
						echo '<div class="cell colspan12 input-control text">';
							...
							echo '<div class="button-group">';
								echo '<a href="'.$folder_regis.'get.xoataptin.php?filename='.$gt['alias_name'].'" onclick="return false;" class="delete_file button"><span class="mif-cross fg-red"></span></a>';
								echo '<a href="'.$folder_regis.$target_files_regis.$gt['alias_name'].'" class="button" target="_blank"><span class="mif-file-download fg-blue"></span></a>';
							echo '</div>';
						echo '</div>';
					echo '</div>';
				}
	...
	<div class="row cells12">
		<div class="cell colspan12 align-center">
			...
			<a href="abtc_regis.php" class="button"><span class="mif-keyboard-return"></span> Trở về</a>
		</div>
	</div>
</div>
</form>
